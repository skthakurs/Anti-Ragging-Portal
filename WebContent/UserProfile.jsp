...
<body>
	...
	<div class="container-fluid">
		...
		<div class="row">
			...
			<div class="col-sm-8">
				<div>
					<button class="float-right " name="edit">
						<img class="float-right" src="icons/edit-icon.png"
							style="height: 60px; width: 60px;"
							onclick="do_change(); return false;" />
					</button>
					...
					<div class="form-row">
						...
						<div class="form-group col-md-6">
							<label for="fathers_contact">Father's Contact</label> <input
								...
								placeholder="Father's Conatact No." disabled>
						</div>
					</div>
					<div class="form-group">
						<label for="inputAddress">Address</label> <input type="text"
							class="form-control" id="inputAddress" name="address"
							value="${address }" placeholder="1234 Main St" disabled>
					</div>
					<div class="form-row">
						<div class="form-group col-md-6">
					...
					<div class="row">
						...
						<div class="col-sm-1">
							<button type="button" class="btn btn-danger" name="cancel"
								...
								onclick="again_change(); return false;">Cancel</button>
						</div>
					</div>
				</form>
			</div>
							...
							$("button[name=edit]")
									.on(
											...
											function() {
												...
												$(
														"input[type=text],input[type=checkbox],input[type=email],input[type=number],input[type=file],select")
														.removeAttr("disabled");
